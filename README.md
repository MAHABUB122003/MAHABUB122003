...
|--------|-------------------|
| **Penetration Testing** | Metasploit, Burp Suite, Nmap, Empire, Mimikatz |
| **Forensics & Analysis** | Autopsy, Volatility, FTK, Wireshark |
| **Malware Analysis** | IDA Pro, Ghidra, x64dbg, Cuckoo Sandbox |
| **Web Testing** | OWASP ZAP, SQLMap, XSStrike, Nuclei |
| **Network Security** | Snort, Suricata, Zeek, TCPDump |
| **Monitoring & SIEM** | Splunk, Wazuh, ELK Stack, Graylog |
| **Development** | Git, Docker, VS Code, Postman |
